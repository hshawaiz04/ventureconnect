    ...
    return (
        <div className="container py-12 md:py-16">
            <Card className="max-w-4xl mx-auto bg-card">
                ...
                <CardContent className="prose-sm md:prose-base max-w-none text-card-foreground prose-headings:text-primary prose-headings:font-headline prose-headings:font-bold prose-h2:text-2xl prose-h2:mb-4 prose-h2:mt-12 prose-h3:text-xl prose-h3:mb-3 prose-h3:mt-8 prose-p:text-muted-foreground prose-strong:text-card-foreground prose-ul:list-disc prose-ul:ml-6 prose-li:text-muted-foreground prose-p:mb-4 prose-ul:mb-4 prose-li:mb-2">
