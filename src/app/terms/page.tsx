        ...
        <div className="container py-12 md:py-16">
            <Card className="max-w-4xl mx-auto bg-card">
                ...
                <CardContent className="prose-sm md:prose-base max-w-none text-card-foreground prose-headings:text-primary prose-headings:font-headline prose-headings:font-bold prose-h2:text-2xl prose-h2:mb-4 prose-h2:mt-12 prose-p:text-muted-foreground prose-strong:text-card-foreground prose-ul:list-disc prose-ul:ml-6 prose-li:text-muted-foreground prose-p:mb-4 prose-ul:mb-4">
                    ...
                    <h2 className="mt-12">1. Eligibility</h2>
                    <p>You must:</p>
                    <ul>
                    ...
                    <h2 className="mt-12">2. Purpose of the Platform</h2>
                    ...
                    <h2 className="mt-12">3. Account Registration</h2>
                    ...
                    <h2 className="mt-12">4. Roles &amp; Permissions</h2>
                    ...
                    <h2 className="mt-12">5. User Content</h2>
                    ...
                    <h2 className="mt-12">6. No Financial, Legal, or Investment Advice</h2>
                    ...
                    <h2 className="mt-12">7. Interactions Between Users</h2>
                    ...
                    <h2 className="mt-12">8. Payments, Fees &amp; Premium Features</h2>
                    ...
                    <h2 className="mt-12">9. Prohibited Activities</h2>
                    ...
                    <h2 className="mt-12">10. Intellectual Property</h2>
                    ...
                    <h2 className="mt-12">11. Disclaimers</h2>
                    ...
                    <h2 className="mt-12">12. Limitation of Liability</h2>
                    ...
                    <h2 className="mt-12">13. Termination</h2>
                    ...
                    <h2 className="mt-12">14. Privacy</h2>
                    ...
                    <h2 className="mt-12">15. Changes to the Terms</h2>
                    ...
                    <h2 className="mt-12">16. Governing Law</h2>
