        ...
        <div className="flex flex-col min-h-screen">
             <section className="relative w-full h-[40vh] flex items-center justify-center">
                ...
                <div className="relative container px-4 md:px-6 text-center text-primary-foreground z-10">
                    <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold font-headline mb-4">Terms of Service</h1>
                    <p className="text-lg md:text-xl text-gray-200">Last Updated: {lastUpdated}</p>
                </div>
            </section>
