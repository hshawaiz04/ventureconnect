    ...
    return (
        <div className="container py-12 md:py-16">
            <Card className="max-w-4xl mx-auto bg-card">
                ...
                <CardContent className="prose-sm md:prose-base max-w-none text-card-foreground prose-headings:text-primary prose-headings:font-headline prose-headings:font-bold prose-h2:text-2xl prose-h2:mt-8 prose-p:text-muted-foreground prose-strong:text-card-foreground prose-ul:list-disc prose-ul:ml-6 prose-li:text-muted-foreground">
                    <p>Welcome to Bridge (“the Platform”). These Terms of Service (“Terms”) govern your access to and use of our website, mobile app, and related services (“Services”). By creating an account, accessing, or using the Platform, you agree to be bound by these Terms.</p>
                    ...
                    <p>Bridge acts as a digital networking and information platform that:</p>
                    <ul>
                    ...
                    <p><strong>Bridge is not an investment advisor, broker, financial institution, or funding provider.</strong> We do not verify claims, guarantee outcomes, or participate in negotiations.</p>
                    ...
                    <p>You may upload: Business proposals, Documents, Messages, Profile information. By uploading content, you grant Bridge a non-exclusive, worldwide, royalty-free license to: Display, Store, Process, Transmit your content solely for providing the Platform’s Services.</p>
                    ...
                    <p>Bridge does not: Provide investment recommendations, Verify the accuracy of proposals, Guarantee the success of any deal, Endorse any user or business opportunity. All interactions, communications, and agreements between users are independent. Bridge is not a party to any investment agreement or transaction.</p>
                    <p>You should consult your own financial, legal, or tax professionals.</p>

                    <h2>7. Interactions Between Users</h2>
                    <p>Users communicate and share information at their own risk. Bridge is not responsible for: Misrepresentation, Fraud, Losses due to user decisions, Failed deals, Disputes between users. We may—but are not obligated to—intervene in disputes.</p>

                    <h2>8. Payments, Fees &amp; Premium Features</h2>
                    <p>Bridge may offer paid features such as: Proposal boosting, Subscription plans, Enhanced visibility, Additional roles/tools. All fees are displayed before purchase. Purchases are non-refundable unless stated otherwise. Payment processing is handled by third-party providers (e.g., Stripe, Razorpay). Bridge does not store card or banking details.</p>
                    ...
                    <p>All Platform content—including logos, UI, code, designs, and branding—is the property of Bridge. You may not copy, modify, distribute, or reverse-engineer any part of the Platform without permission.</p>
                    ...
                    <p>To the maximum extent permitted by law: Bridge and its team are not liable for: Lost investments or financial loss, Lost data, Business interruption, Indirect, incidental, or consequential damages. Our total liability shall not exceed the amount you paid to Bridge in the last 6 months.</p>
                    ...
                    <h2>14. Privacy</h2>
                    <p>Your use of the Platform is also governed by our Privacy Policy, which explains: What data we collect, How it is used, How it is stored. You must agree to the Privacy Policy to use Bridge.</p>
