    ...
    return (
        <div className="container py-12 md:py-16">
            <Card className="max-w-4xl mx-auto bg-card">
                ...
                <CardContent className="prose-sm md:prose-base max-w-none text-card-foreground prose-headings:text-primary prose-headings:font-headline prose-headings:font-bold prose-p:text-muted-foreground prose-strong:text-card-foreground prose-ul:list-disc prose-ul:ml-6 prose-li:text-muted-foreground">
                    ...
                    <h2 className="text-2xl mt-12 mb-4">1. Eligibility</h2>
                    <p>You must:</p>
                    <ul>
                    ...
                    <h2 className="text-2xl mt-12 mb-4">2. Purpose of the Platform</h2>
                    ...
                    <h2 className="text-2xl mt-12 mb-4">3. Account Registration</h2>
                    ...
                    <h2 className="text-2xl mt-12 mb-4">4. Roles &amp; Permissions</h2>
                    ...
                    <h2 className="text-2xl mt-12 mb-4">5. User Content</h2>
                    ...
                    <h2 className="text-2xl mt-12 mb-4">6. No Financial, Legal, or Investment Advice</h2>
                    ...
                    <h2 className="text-2xl mt-12 mb-4">7. Interactions Between Users</h2>
                    ...
                    <h2 className="text-2xl mt-12 mb-4">8. Payments, Fees &amp; Premium Features</h2>
                    ...
                    <h2 className="text-2xl mt-12 mb-4">9. Prohibited Activities</h2>
                    ...
                    <h2 className="text-2xl mt-12 mb-4">10. Intellectual Property</h2>
                    ...
                    <h2 className="text-2xl mt-12 mb-4">11. Disclaimers</h2>
                    ...
                    <h2 className="text-2xl mt-12 mb-4">12. Limitation of Liability</h2>
                    ...
                    <h2 className="text-2xl mt-12 mb-4">13. Termination</h2>
                    ...
                    <h2 className="text-2xl mt-12 mb-4">14. Privacy</h2>
                    ...
                    <h2 className="text-2xl mt-12 mb-4">15. Changes to the Terms</h2>
                    ...
                    <h2 className="text-2xl mt-12 mb-4">16. Governing Law</h2>
